...
var chart_pdtbar = {
		...
		render:function(option,structure_obj){
			...
			obj_xAxis.axisLabel = {show: true,interval: 'auto',formatter: '{value} %'};
			obj_xAxis.show = true;
			//百分比最大值100
			obj_xAxis.max = 100;
			...
			//气泡显示格式
			option = chart_option_event.addTooltipFormatter(chart_option_event.chart_type_set.PDT_BAR,option);
		},
		//生成辅助线
