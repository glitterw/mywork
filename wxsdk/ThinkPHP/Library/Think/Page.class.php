...
class Page {
    ...
    protected $config  =    array(
		...
		'first'=>'首页',
		'last'=>'末页',
		//'theme'=>'共 %totalRow% %header% %nowPage%/%totalPage% 页 %upPage% %downPage% %first%  %prePage%  %linkPage%  %nextPage% %end%');
		'theme'=> '共 <font color="red">%totalRow%</font> %header% %nowPage%/%totalPage% 页 %first% %upPage% %linkPage% %downPage% %end%');
    // 默认分页变量名
    protected $varPage;
