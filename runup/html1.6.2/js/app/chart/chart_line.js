...
//			var data_y = structure_obj.result.y;//查询后的原始结果
...
//			_xAxis.push(obj_xAxis);
			...
			option = chart_option_event.addTooltipFormatter(chart_option_event.chart_type_set.LINE,option);
		},
		//直线还是曲线    smooth 平滑度
		...
		getGuideFormulas:function(id){
			var guide = {};
			var list = this.guide_formulas;
			if(list){
