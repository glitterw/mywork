...
myLayer = new function() {
        ...
        layui.use('layer', function(){
            ...
            layer.open({
                    ...
                    ,success: function(layero, index){
                        $(".my-layer-cancel .cancel").bind("click",function(){
                            layer.close(index);
                        })
                        $(".my-layer-cancel .confirm").bind("click",function(){
                            layer.close(index);
                        })
                    }
                }
     ...
     *@action  当前页捕获内容弹出弹窗
     *@param  jq对象    $obj 必选项 内容
     *@param  array     _area  弹窗的宽高
     *@param  _callbackFn  成功加载后自定义操作函数
     * @param  _skin  自定义的class
     */
    this.showDom2 = function($obj,_area,_callbackFn,_skin) {
        layui.use('layer', function(){
            var layer = layui.layer;
            layer.open({
                    type: 1,
