...
$(function() {
	...
	$(document).on('myinit', '.Mcolor .Mc1', function() {
		var _this = this;
		setTimeout(function() {
			_this.width = 1, _this.height = 256, ctx = _this.getContext("2d"), ctx.drawImage(colorImg, 0, 0);
			var oColor = 'rgba(0,0,255,1)',
				oColor2 = 'rgba(0,0,255,0)',
				c2 = $(_this).siblings('.Mc2').get(0),
