...
function getWXData(){
    ...
    $.ajax({
        type: 'GET',
        url: 'http://www.huijia-edu.com/tp/Home/Sdk/signature?url='+pageUrl,
        dataType: 'json',
        success: function(data){
            ...
            if(data.errorcode==0){//签名成功
                ...
                wx.config({
                    ...
                    appId: 'wx6b092cc73e0b27ed',//'wx2c4f1571db180b48', // 必填，公众号的唯一标识
                ...
                wx.ready(function(){
                    ...
                    var shareContent={
                        ...
                        imgUrl: 'http://www.huijia-edu.com/xin/images/banner_share.jpg', // 分享图标
                        success: function () {
                            // 用户确认分享后执行的回调函数
                        },
                        cancel: function () {
